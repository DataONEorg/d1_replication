...
public abstract class ReplicationCommunication {
    ...
    public static Log log = LogFactory.getLog(ReplicationCommunication.class);

    protected ReplicationService replicationService = ReplicationFactory.getReplicationService();
	
	public abstract boolean requestReplication(NodeReference targetNodeId, SystemMetadata sysmeta) throws BaseException;
	
	public abstract Checksum getChecksumFromMN(Identifier identifier, NodeReference nodeId, SystemMetadata sysmeta) throws BaseException;
